...
#ifndef SRC_ACRE2ARMA_SIGNAL_MODELS_LONGLEYRICE_ITM_H_
#define SRC_ACRE2ARMA_SIGNAL_MODELS_LONGLEYRICE_ITM_H_
...
#endif /* SRC_ACRE2ARMA_SIGNAL_MODELS_LONGLEYRICE_ITM_H_ */
