...
acre::signal::model::itm::LongleyRiceITM::LongleyRiceITM() {}

acre::signal::model::itm::LongleyRiceITM::~LongleyRiceITM() {}

float64_t acre::signal::model::itm::LongleyRiceITM::FORTRAN_DIM(const float64_t x, const float64_t y) {
    if (x > y) {
        return x - y;
    } else {
        return 0.0;
...
float64_t acre::signal::model::itm::LongleyRiceITM::Fn(const float64_t v_square) {
    float64_t a = 0.0;
...
float64_t acre::signal::model::itm::LongleyRiceITM::H_0(const float64_t r, const float64_t et) {
...
float64_t acre::signal::model::itm::LongleyRiceITM::F_0(const float64_t td) {
    // [Alg 6.9]
    if (td <= 10e3) {
        // below 10 km
...
float64_t acre::signal::model::itm::LongleyRiceITM::adiff(const float64_t s, prop_type &prop) {
...
float64_t acre::signal::model::itm::LongleyRiceITM::A_scat(const float64_t s, prop_type &prop) {
...
float64_t acre::signal::model::itm::LongleyRiceITM::abq_alos(const std::complex<float64_t> &r) {
    return std::pow(r.real(), 2) + std::pow(r.imag(), 2);
}

float64_t acre::signal::model::itm::LongleyRiceITM::A_los(const float64_t d, prop_type &prop) {
...
void acre::signal::model::itm::LongleyRiceITM::lrprop(const float64_t d, prop_type &prop) {
...
void acre::signal::model::itm::LongleyRiceITM::qlra(const SiteCriteria *const kst, const RadioClimate klimx, const VariabilityMode mdvarx, prop_type &prop, propv_type &propv) {
    float64_t q = 0.0;
...
float64_t acre::signal::model::itm::LongleyRiceITM::qerfi(const float64_t q) {
...
void acre::signal::model::itm::LongleyRiceITM::qlrps(const float64_t fmhz, const float64_t zsys, const float64_t en0, const Polarization ipol, const float64_t eps, const float64_t sgm, prop_type &prop) {
...
float64_t acre::signal::model::itm::LongleyRiceITM::curve(float64_t const c1, float64_t const c2, float64_t const x1, float64_t const x2, float64_t const x3, float64_t const de) {
...
float64_t acre::signal::model::itm::LongleyRiceITM::avar(const float64_t zzt, const float64_t zzl, const float64_t zzc, prop_type &prop, propv_type &propv) {
...
void acre::signal::model::itm::LongleyRiceITM::hzns(const float64_t *const pfl, prop_type &prop) {
...
void acre::signal::model::itm::LongleyRiceITM::zlsq1(const float64_t *const z, const float64_t x1, const float64_t x2, float64_t& z0, float64_t& zn) {
...
float64_t acre::signal::model::itm::LongleyRiceITM::qtile(const int32_t nn, float64_t *const a, const int32_t ir) {
    float64_t q = 0.0;
    int32_t j1 = 0;
    int32_t i0 = 0;
    bool done = false;
...
float64_t acre::signal::model::itm::LongleyRiceITM::dlthx(const float64_t *const pfl, const float64_t x1, const float64_t x2) {
    float64_t *s = nullptr;
...
void acre::signal::model::itm::LongleyRiceITM::qlrpfl(const float64_t *const pfl, const RadioClimate klimx, const int32_t mdvarx, prop_type &prop, propv_type &propv) {
    prop.d = pfl[0] * pfl[1];
    const int32_t np = static_cast<int32_t>(pfl[0]);
...
void acre::signal::model::itm::LongleyRiceITM::pointToPointMDH(const float64_t *const elev,
        const float64_t tht_m,
        const float64_t rht_m,
        const float64_t eps_dielect,
        const float64_t sgm_conductivity,
...
void acre::signal::model::itm::LongleyRiceITM::pointToPointDH(const float64_t *const elev,
        const float64_t tht_m,
        const float64_t rht_m,
        const float64_t eps_dielect,
        const float64_t sgm_conductivity,
...
void acre::signal::model::itm::LongleyRiceITM::area(const VariabilityMode ModVar,
